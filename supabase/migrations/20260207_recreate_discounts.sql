-- =============================================
-- RE-CREAR Sistema de Descuentos por Porcentaje
-- Fecha: 2026-02-07
-- Este script elimina y vuelve a crear todo el sistema
-- =============================================

-- Eliminar todo en orden correcto (CASCADE elimina dependencias automáticamente)
DROP VIEW IF EXISTS products_with_active_discount CASCADE;
DROP TABLE IF EXISTS discount_drops CASCADE;
DROP TABLE IF EXISTS discount_products CASCADE;
DROP TABLE IF EXISTS discounts CASCADE;
DROP FUNCTION IF EXISTS update_discount_updated_at() CASCADE;
DROP FUNCTION IF EXISTS check_discount_overlap() CASCADE;

-- =============================================
-- AHORA VOLVER A CREAR TODO
-- =============================================
...
CREATE INDEX idx_discount_drops_discount ON discount_drops(discount_id);
CREATE INDEX idx_discount_drops_drop ON discount_drops(drop_id);
